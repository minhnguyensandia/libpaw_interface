...
! This is the second part of initialization:
! based on information previously read and stored
! calculate physical quantities required by PAW
! This part should be called only once per calculation
...
!NOTE : I've removed parts related to meta-GGA for now
!will put them back later
